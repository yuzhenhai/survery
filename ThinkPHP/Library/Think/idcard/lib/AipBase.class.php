...
* the License.
*/
namespace Think\idcard\lib;

require_once 'AipHttpClient.class.php';
require_once 'AipBCEUtil.class.php';
// use Think\idcard\lib\AipHttpClient;
// use Think\idcard\lib\AipBCEUtil;
// use Think\idcard\lib\AipHttpClient;
// use Think\idcard\lib\AipBCEUtil;
...
class AipBase {
     ...
     * @var string
     */
    protected $appId = '11060986';

    /**
     * apiKey
     * @var string
     */
    protected $apiKey = 'pCZyDlnIWcX5ecMThwyznKGM';
    
    /**
     * secretKey
     * @var string
     */
    protected $secretKey = 'ShOcGLDXSfvYYdAOPRi8VTiNAnFHb8jy';
